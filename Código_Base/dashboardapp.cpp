...
DashboardApp::DashboardApp(QWidget* parent = nullptr) : QWidget(parent) {
...
void DashboardApp::crearNuevaPeticion() {
    QDialog dialog(this);
...
QStringList DashboardApp::getAsignaturasDisponibles() {
...
bool DashboardApp::esHorarioDisponible(const QString& bloque, const QString& sala) {
